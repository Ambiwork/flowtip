 ...
 */
export function getLastRegion(props, state) {
...
export function getRegion(props, state) {
...
export function getTailLength(props, state) {
...
export function getTailBase(props, state) {
  var lastRegion = getLastRegion(props, state);
...
export function getOverlap(props, state) {
...
export function getOffset(props, state) {
